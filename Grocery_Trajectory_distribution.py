...
df_journey_collapsed.to_csv(r"C:\Users\60848\OneDrive - Bain\Desktop\Project_Genome\casework\Woolworths\Grocery_Journeys_summary_Global_FE_Update.csv")
...
if make_plots:
    ...
    for journey in df_journey_collapsed["Journey"].dropna().unique():
        ...
        plt.savefig("Grocery_Clean_TSR_Angle")
        plt.grid(True)
        plt.show()
    ...
    plt.ylabel("Density")
    plt.title("Grocery_Clean_Insurance_Distribution_TSR_by_Journey")
    plt.grid(True)
