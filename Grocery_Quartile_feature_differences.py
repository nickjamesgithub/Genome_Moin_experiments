...
per_co = (panel.groupby(["Ticker_base","Company_name"])
               .agg(Revenue_growth_3_f_med=("Revenue_growth_3_f","median"),
...
features = ["Revenue_growth_3_f_med","EBIT_margin_med","EVA_ratio_bespoke_med",
            "Capital_efficiency_med","NAV_1_f_med",
            "Years_EVA_pos","Years_RG3_gt_2p7","TSR_10Y"]
quartile_medians = (per_co.groupby("TSR_10Y_qtile")[features]
                           .median()
                           .reset_index())
