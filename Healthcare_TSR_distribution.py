...
# Read the data
df_read = pd.read_csv(r"C:\Users\60848\OneDrive - Bain\Desktop\Genome_code_250605\Genome-pipeline-code\Genome-pipeline-code\global_platform_data\Global_data.csv")
df = df_read[df_read["Sector"].isin(["Healthcare","Health Care"])].copy()

# Apply Genome Filter
genome_filtering = False
plot_label = "Global_Healthcare"
