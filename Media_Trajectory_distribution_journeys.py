...
# ===== Load INSURANCE file =====
data = pd.read_csv(r"C:\Users\60848\OneDrive - Bain\Desktop\Project_Genome\casework\Nine\media_data_global_mapped.csv")
...
df_journey_collapsed.to_csv(r"C:\Users\60848\OneDrive - Bain\Desktop\Project_Genome\casework\Nine\Media_global_Journeys_summary_Global_FE_Update.csv")
...
if make_plots:
    ...
    for journey in df_journey_collapsed["Journey"].dropna().unique():
        ...
        plt.savefig("Media_Clean_TSR_Angle")
        plt.grid(True)
        plt.show()
    ...
    plt.ylabel("Density")
    plt.title("Media_Clean_Insurance_Distribution_TSR_by_Journey")
    plt.grid(True)
