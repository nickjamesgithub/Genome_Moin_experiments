...
# Read the data
df = pd.read_csv(r"C:\Users\60848\OneDrive - Bain\Desktop\Project_Genome\Journeys\Journeys_summary_Global_FE_Update_filtered.csv")
...
df_filtered = df[df["Sector"].isin(desired_sectors)].copy()
