...
# Read the data
df = pd.read_csv(r"C:\Users\60848\OneDrive - Bain\Desktop\Project_Genome\casework\Woolworths\Grocery_Journeys_summary_Global_FE_Update.csv")

# Desired sectors and date range
# country_list = ["USA", 'AUS', 'INDIA', 'JAPAN', 'EURO', 'UK'] # "USA", 'AUS', 'INDIA', 'JAPAN', 'EURO', 'UK'
unique_sectors = ["Grocery"]
desired_sectors = unique_sectors
start_year = 2014
end_year = 2025

# 1. Filter by Country & Sector
# df = df_full[df_full["Sector"].isin(desired_sectors)].copy()
